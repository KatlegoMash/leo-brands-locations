...
window.ActiveXObject &&
  ...
  (function(h, j) {
      ...
      w: function() {
        ...
        if (this.v !== this.font)
          try {
            ...
            a.push(
              e.font,
              [c.fontStyle, c.fontWeight, b.offsetHeight, c.fontFamily].join(
                " "
              )
            );
          } catch (d) {}
        ...
        initElement: function(a) {
          ...
          a.toDataURL = function(l, z) {
            ("" + l).replace(/[A-Z]+/g, W) === "image/jpeg"
              ? o.a.push(e.toDataURL, l, typeof z === "number" ? z : "")
    ...
    j.createStyleSheet().cssText =
      r + "{display:inline-block;overflow:hidden;width:300px;height:150px}";
