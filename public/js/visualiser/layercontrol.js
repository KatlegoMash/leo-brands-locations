(function e(t, n, r) {
...
})(
  {
    1: [
      function(require, module, exports) {
        ...
        L.Control.Layers.Minimap = L.Control.Layers.extend({
          options: {
            ...
            topPadding: 10,
            bottomPadding: 40,
            overlayBackgroundLayer: L.tileLayer(
          ...
          filter: function(string) {
            ...
            for (var i = 0; i < layerLabels.length; i++) {
              ...
              if (
                string !== "" &&
                layerLabel._layerName.indexOf(string) === -1
              ) {
                L.DomUtil.addClass(layerLabel, "leaflet-minimap-hidden");
              } else {
                L.DomUtil.removeClass(layerLabel, "leaflet-minimap-hidden");
                visibleLayers[layerLabel._layerName] = cloneLayer(
                  layerLabel._minimap._layer
                );
              }
            }
            this._onListScroll();
          ...
          _onListScroll: function() {
            ...
            var minimaps = this._map._container.querySelectorAll(
              'label[class="leaflet-minimap-container"]'
            );
            ...
            if (this.isCollapsed()) {
              ...
              last = Math.ceil(
                (scrollTop + container.clientHeight) / minimapHeight
              );
            }
      ...
      { "leaflet-clonelayer": 2, "leaflet.sync": 3 }
    ],
    2: [
      function(require, module, exports) {
